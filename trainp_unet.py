# -*- coding: utf-8 -*-
"""
Created on Fri Mar 24 19:02:57 2023
...
title = "(p,unet,vgg19_bn,adam,tversky)"
...
# Image paths
train_dir = r"C:\Users\GPU\particle_size_project\Dataset\wood_mix_500_1088\train\Images\*.png"
train_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\wood_mix_500_1088\train\Masks\*.png"
val_dir = r"C:\Users\GPU\particle_size_project\Dataset\wood_mix_500_1088\valid\Images\*.png"
val_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\wood_mix_500_1088\valid\Masks\*.png"
# --------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    # model = smp.Unet(encoder_name='vgg13', encoder_depth=5,
    ...
    model = smp.Linknet(encoder_name='timm-regnety_160', encoder_depth=5,
                        encoder_weights='imagenet', decoder_use_batchnorm=True,
