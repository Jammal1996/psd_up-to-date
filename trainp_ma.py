# -*- coding: utf-8 -*-
"""
Created on Sat Mar  4 04:25:45 2023
...
title = "(p,ma,regnety_040,sgd,dice)"
...
# Image paths
train_dir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix\train\Images\*.png"
train_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix\train\Masks\*.png"
val_dir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix\valid\Images\*.png"
val_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix\valid\Masks\*.png"
# --------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    model = smp.MAnet(encoder_name='timm-regnety_040', encoder_depth=5, encoder_weights='imagenet',
