# -*- coding: utf-8 -*-
"""
Created on Tue Jul 18 23:31:57 2023
...
from dataset_p import SegmentationDataSet
from transformations_p import ComposeDouble, FunctionWrapperDouble, create_dense_target, normalize_01, AlbuSeg2d
...
title = "(p1_inv,ln,vgg13_bn,adam,dice,d=500,lr=1e-6,e=100)"
...
# Image paths
train_dir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_500\train\Images\*.png"
train_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_500\train\Masks\*.png"
val_dir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_500\valid\Images\*.png"
val_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_500\valid\Masks\*.png"
# --------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    # model = smp.UnetPlusPlus(encoder_name='vgg13_bn', encoder_depth=5,
    #               encoder_weights='imagenet', decoder_use_batchnorm=True,
