# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 02:19:29 2022
...
title = "(p,unet++,vgg13,radam,tversky,d=500,c=50,t=200,lr=1e-4,e=50)"
...
# Image paths
train_dir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix_500\train\Images\*.png"
train_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix_500\train\Masks\*.png"
val_dir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix_500\valid\Images\*.png"
val_maskdir = r"C:\Users\GPU\particle_size_project\Dataset\plastic_mix_500\valid\Masks\*.png"
# --------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    model = smp.UnetPlusPlus(encoder_name='vgg13', encoder_depth=5,
                  ...
                  decoder_channels=(1024, 512, 256, 128, 64), decoder_attention_type=None,
    ...
    criterion = TverskyLoss(mode="binary")
